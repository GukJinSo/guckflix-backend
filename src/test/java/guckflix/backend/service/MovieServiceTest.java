...
class MovieServiceTest {
    ...
    public void updateTest() throws Exception {
        ...
        Movie movie = Movie.builder().title("Test Movie")
                .overview("테스트 영화")
                .genres(GenreCached.genreToString(Collections.singletonList(Map.entry(1L, "Test Genre"))))
        ...
        movieUpdateForm.setGenres(Collections.singletonList(Map.entry(2L, "Genre Changed")));
